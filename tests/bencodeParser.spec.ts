...
describe("Bencoded parser tests", () => {
    it("i42e is parsed as the integer 42.", () => {
        let parser = new Parsing.BencodedParser("i42e");
        let parsedObject = parser.parse() as BencodeObjects.BencodedInteger;
        expect(parsedObject.value).toEqual(42);
    });

    it("9:abcdefghi is parsed as the string abcdefghi", () => {
        let parser = new Parsing.BencodedParser("9:abcdefghi");
        let parsedObject = parser.parse() as BencodeObjects.BencodedString;
        expect(parsedObject.value).toEqual("abcdefghi");
    });

    it("0: is parsed as the empty string", () => {
        let parser = new Parsing.BencodedParser("0:");
        let parsedObject = parser.parse() as BencodeObjects.BencodedString;
        expect(parsedObject.value).toEqual("");
    });

    it("10:1234567890 is parsed as 1234567890", () => {
        let parser = new Parsing.BencodedParser("10:1234567890");
        let parsedObject = parser.parse() as BencodeObjects.BencodedString;
        expect(parsedObject.value).toEqual("1234567890");
    });

    it("14:1234567890 123 is parsed as 1234567890 123", () => {
        let parser = new Parsing.BencodedParser("14:1234567890 123");
        let parsedObject = parser.parse() as BencodeObjects.BencodedString;
    ...
    it("l4:1234e is parsed as a list containing the string 1234", () => {
        let parser = new Parsing.BencodedParser("l4:1234e");
        let parsedObject = parser.parse() as BencodeObjects.BencodedList;
        parsedObject.value.forEach((element: BencodeObjects.BencodedString) => {
            expect(element.value).toEqual("1234");
        });
    });

    it("l4:12343:abce is parsed as a list containing the string 1234 and abc", () => {
        let parser = new Parsing.BencodedParser("l4:12343:abce");
        let parsedObject = parser.parse() as BencodeObjects.BencodedList;
        let elements = parsedObject.value as BencodeObjects.BencodedString[];
    ...
    it("l4:12343:abci42ee is parsed as a list containing 1234, abc and 42", () => {
        let parser = new Parsing.BencodedParser("l4:12343:abci42ee");
        let parsedObject = parser.parse() as BencodeObjects.BencodedList;
        let elements = parsedObject.value as BencodeObjects.BencodedString[];
        expect(elements[0].value).toEqual("1234");
        expect(elements[1].value).toEqual("abc");
    ...
    it("l4:12343:abci42el4:12343:abci42eee is parsed as a list containing 1234, abc, 42 AND a list containing 1234, abc, 42", () => {
        let parser = new Parsing.BencodedParser("l4:12343:abci42el4:12343:abci42eee");
        let parsedObject = parser.parse() as BencodeObjects.BencodedList;
        ...
        expect(elements[1].value).toEqual("abc");
        expect(elements[2].value).toEqual(42);
        let nestedElements = elements[3].value as BencodeObjects.BencodedObject<BencodeObjects.IBencodedObject>;
    ...
    it("d3:cow3:moo4:spam4:eggse is parsed as the dictionary { 'cow' => 'moo', 'spam' => 'eggs' }", () => {
        let parser = new Parsing.BencodedParser("d3:cow3:moo4:spam4:eggse");
        let parsedObject = parser.parse() as BencodeObjects.BencodedDictionary;
    ...
    it("li0ed3:keyd9:inner_keyi42eeee is parsed as list containing the integer 0 and the dictionary { 'key' => { 'inner_key' => 42 } }", () => {
        let parser = new Parsing.BencodedParser("li0ed3:keyd9:inner_keyi42ee");
        let parsedObject = parser.parse() as BencodeObjects.BencodedList;
        let integer = parsedObject.value[0] as BencodeObjects.BencodedInteger;
        expect(integer.value).toEqual(0);
        let dict = parsedObject.value[1] as BencodeObjects.BencodedDictionary;
    ...
    it("d13:file-durationli42ee10:file-mediali-1ei0ei-1ee is parsed as the dictionary { 'file-duration' => [42], 'file-media' => [-1, 0, -1] }", () => {
        let parser = new Parsing.BencodedParser("d13:file-durationli42ee10:file-mediali-1ei0ei-1ee");
        let parsedObject = parser.parse() as BencodeObjects.BencodedDictionary;
    ...
    "is parsed as the dictionary { 'publisher' => 'bob', 'publisher-webpage' => 'www.example.com', 'publisher.location' => 'home' }", () => {
        let parser = new Parsing.BencodedParser("d9:publisher3:bob17:publisher-webpage15:www.example.com18:publisher.location4:homee");
        let parsedObject = parser.parse() as BencodeObjects.BencodedDictionary;
